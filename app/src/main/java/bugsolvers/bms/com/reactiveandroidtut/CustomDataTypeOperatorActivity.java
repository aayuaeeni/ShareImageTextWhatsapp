...
public class CustomDataTypeOperatorActivity extends AppCompatActivity
{
     ...
     */
    private static final String TAG = CustomDataTypeOperatorActivity.class.getSimpleName();
